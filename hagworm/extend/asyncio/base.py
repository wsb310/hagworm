...
class Utils(base.Utils):
    ...
    def call_soon(callback, *args):
        ...
        return loop.call_soon(async_adapter(callback), *args)
    ...
    def call_later(delay, callback, *args):
        ...
        return loop.call_later(delay, async_adapter(callback), *args)
    ...
    def call_at(when, callback, *args):
        ...
        return loop.call_at(when, async_adapter(callback), *args)
